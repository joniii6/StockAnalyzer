...
for i in range(df5.shape[0]):
	if i == 0:
		col1.metric(df6.iloc[i]['Name'], df6.iloc[i]['value_today'], 3)
	if i == 1:
		col2.metric(df6.iloc[i]['Name'], df6.iloc[i]['value_today'], 3)
	if i == 2:
		col3.metric(df6.iloc[i]['Name'], df6.iloc[i]['value_today'], 3)
	if i == 3:
		col4.metric(df6.iloc[i]['Name'], df6.iloc[i]['value_today'], 3)
