...
st.write("Here it would be possible to show the option to get more insights (as in stock analysis)")


st.subheader("Build your optimal portfolio")
st.write("Add explanation of the process of building the optimal portfolio")
